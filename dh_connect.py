...
def dhan_autologon():
    dhan_session_url = 'https://web.dhan.co/'
    ...
    driver.get(dhan_session_url)
    driver.implicitly_wait(10)
    driver.find_element(By.XPATH,'/html/body/app-root/div[1]/app-login/div/div[2]/div/div[2]/div/div/div[4]/div[2]/div[2]/span/div/img').click()
    
    dhan_mob_number = 9673843177
    dhan_pwd = 'Jagdish@7'
    mobile_number = driver.find_element(By.XPATH,'/html/body/app-root/div[1]/app-login/div/div[2]/div/div[2]/div/div/div[2]/div[1]/form/div/input')
    mobile_number.send_keys(dhan_mob_number)
    driver.find_element(By.XPATH,'/html/body/app-root/div[1]/app-login/div/div[2]/div/div[2]/div/div/div[2]/div[1]/form/button').click()
    
    password = driver.find_element(By.XPATH,'/html/body/app-root/div[1]/app-login/div/div[2]/div/div[2]/div/div/div[2]/div[1]/form/div[2]/input')
    password.send_keys(dhan_pwd)
    driver.find_element(By.XPATH,'/html/body/app-root/div[1]/app-login/div/div[2]/div/div[2]/div/div/div[2]/div[1]/form/button').click()
