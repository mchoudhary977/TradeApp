# -*- coding: utf-8 -*-
"""
ICICI Direct - shooting star candle identification

@author: Mukesh Choudhary

---------------SHOOTING STAR CANDLE---------------
Candle in which upper wick is atleast twice the size of the body.

Body can be red or green (although red is preferred)

Lower wick should be small or non-existent

Viewed as a bearish reversal candlestick when occuring during an uptrend.
"""
